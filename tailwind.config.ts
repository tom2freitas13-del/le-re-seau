  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        sand: { DEFAULT: "hsl(var(--sand))", light: "hsl(var(--sand-light))", dark: "hsl(var(--sand-dark))" },
        ocean: { DEFAULT: "hsl(var(--ocean))", light: "hsl(var(--ocean-light))", mid: "hsl(var(--ocean-mid))", dark: "hsl(var(--ocean-dark))" },
        pine: { DEFAULT: "hsl(var(--pine))", light: "hsl(var(--pine-light))" },
        gold: "hsl(var(--gold))",
        sidebar: {
