...
('Pointe de Grignon', 'surf', 'Totalement exposé à la houle sans aucune protection, considéré comme l''un des meilleurs spots de l''île, très fréquenté par les surfeurs confirmés.', 'Route de la Pointe de Grignon, 17590 Ars-en-Ré', 46.202271, -1.530801, '/images/activities/surf.jpg'),
-- Sorties
