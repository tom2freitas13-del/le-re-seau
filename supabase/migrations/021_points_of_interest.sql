...
-- Surf
('Les Grenettes', 'surf', 'Spot le plus accessible et connu de l''île, vagues plutôt douces sur fond de reef rocheux. Idéal pour débuter, mais très fréquenté l''été.', 'Chemin des Grenettes, 17580 Sainte-Marie-de-Ré', 46.162812, -1.362847, '/images/activities/surf.jpg'),
...
('Petit Bec & Diamond Head', 'surf', 'Entouré de forêts de pins, loin de la foule touristique. Vagues puissantes et rapides pouvant atteindre 3 mètres, réservé aux surfeurs expérimentés.', 'Saint-Clément-des-Baleines', 46.230292, -1.548126, '/images/activities/surf.jpg'),
...
('City-Stade d''Ars-en-Ré', 'sport', 'Terrain de football et basket en accès libre, avec piste de course autour, près du port.', 'Rue du Port, 17590 Ars-en-Ré', 46.207328, -1.514395, '/images/activities/sport.jpg'),
-- Plages
...
('Plage du Lizay', 'plage', 'Plage sauvage bordée de dunes, prisée des surfeurs, marcheurs et familles en quête de tranquillité.', 'Rue de la Plage, 17590 Saint-Clément-des-Baleines', 46.238144, -1.550651, '/images/activities/plage.jpg'),
