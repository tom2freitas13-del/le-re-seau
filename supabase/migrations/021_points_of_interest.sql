...
('Pointe de Grignon', 'surf', 'Totalement exposé à la houle sans aucune protection, considéré comme l''un des meilleurs spots de l''île, très fréquenté par les surfeurs confirmés.', 'Route de la Pointe de Grignon, 17590 Ars-en-Ré', 46.204462, -1.535630, '/images/activities/surf.jpg'),
-- Sorties
...
-- Plages
('Conche des Baleines', 'plage', 'Considérée par les connaisseurs comme la plus belle plage de l''île : 3 km de sable fin et l''un des plus beaux couchers de soleil de la côte.', 'Chemin de la Conche, 17590 Saint-Clément-des-Baleines', 46.246427, -1.540398, '/images/activities/plage.jpg'),
('Trousse-Chemise', 'plage', 'Plage mythique rendue célèbre par la chanson de Charles Aznavour, accessible à pied à travers la forêt, cadre naturel préservé.', 'Trousse Chemise, 17880 Les Portes-en-Ré', 46.235289, -1.475688, '/images/activities/plage.jpg'),
('Plage du Lizay', 'plage', 'Plage sauvage bordée de dunes, prisée des surfeurs, marcheurs et familles en quête de tranquillité.', 'Route du Lizay, 17880 Les Portes-en-Ré', 46.256637, -1.515018, '/images/activities/plage.jpg'),
('Les Gollandières', 'plage', 'Une des plages les plus fréquentées de l''île, large étendue de sable fin plein sud, baignade surveillée en saison.', 'Avenue des Gollandières, 17580 Le Bois-Plage-en-Ré', 46.180381, -1.403162, '/images/activities/plage.jpg'),
