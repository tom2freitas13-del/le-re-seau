...
('Plage de Gouillaud', 'surf', 'Spot prisé des locaux, vagues de qualité toute l''année mais peu puissantes. Uniquement exploitable à marée haute.', 'Le Fond Gouillaud, 17580 Le Bois-Plage-en-Ré', 46.167915, -1.371565, '/images/activities/surf.jpg'),
('Sous le Phare des Baleines', 'surf', 'À la pointe nord-ouest de l''île, ce spot capte la houle de plein fouet : vagues puissantes et creuses, surtout par houle d''automne ou d''hiver.', 'Allée du Phare, 17590 Saint-Clément-des-Baleines', 46.244906, -1.559249, '/images/activities/surf.jpg'),
...
('Pointe de Grignon', 'surf', 'Totalement exposé à la houle sans aucune protection, considéré comme l''un des meilleurs spots de l''île, très fréquenté par les surfeurs confirmés.', 'Route de la Pointe de Grignon, 17590 Ars-en-Ré', 46.204271, -1.535704, '/images/activities/surf.jpg'),
-- Sorties
...
-- Plages
('Conche des Baleines', 'plage', 'Considérée par les connaisseurs comme la plus belle plage de l''île : 3 km de sable fin et l''un des plus beaux couchers de soleil de la côte.', 'Chemin de la Conche, 17590 Saint-Clément-des-Baleines', 46.245470, -1.538490, '/images/activities/plage.jpg'),
('Trousse-Chemise', 'plage', 'Plage mythique rendue célèbre par la chanson de Charles Aznavour, accessible à pied à travers la forêt, cadre naturel préservé.', 'Trousse Chemise, 17880 Les Portes-en-Ré', 46.235222, -1.475562, '/images/activities/plage.jpg'),
('Plage du Lizay', 'plage', 'Plage sauvage bordée de dunes, prisée des surfeurs, marcheurs et familles en quête de tranquillité.', 'Route du Lizay, 17880 Les Portes-en-Ré', 46.256847, -1.516243, '/images/activities/plage.jpg'),
('Les Gollandières', 'plage', 'Une des plages les plus fréquentées de l''île, large étendue de sable fin plein sud, baignade surveillée en saison.', 'Avenue des Gollandières, 17580 Le Bois-Plage-en-Ré', 46.180196, -1.402586, '/images/activities/plage.jpg'),
